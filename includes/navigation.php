...
<div class="nav">
    ...
    <ul class="mainmenu">
      ...
      <li><span><a>Organizations</a></span><div class="messages"></div></li>
        <ul class="submenu" id="medicine">
