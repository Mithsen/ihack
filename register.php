<?php
 ...
 $query = "INSERT INTO donor
            (username,password,firstName,lastName,address,contactNumber,nic,birthday,email,bloodGroup,gender)
             VALUES
             ('$username','$password','$first_name','$last_name','$address','$contact','$nic','$birthday','$email','$type','$gender')";
...
<body>
    ...
    <form name='myForm' action='#' method ='post' onsubmit='return validateFormMed()' align="center">
        <fieldset>
            ...
            <input type='text' class='inputField' name='txtFirstName' autocomplete='off'/><br/>
            <p></p>
            <label for='name'>Last Name: </label>
            <input type='text' class='inputField' name='txtLastName' autocomplete='off' /><br/>
            <p></p>
            ...
            <p></p>
            <label>NIC: </label>
            <input type='text' class='inputField' name='txtNIC' autocomplete='off'/><br/>
            <p></p>
            <label>Birth Day: </label>
            <input type='date' class='inputField' name='txtbirthday' autocomplete='off'/><br/>
            <p></p>
            <label>Email: </label>
            <input type='text' class='inputField' name='txtemail' autocomplete='off'/><br/>
            <p></p>
            <label for='Blood Group'>Type: </label>
