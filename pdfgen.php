...
<div class="container-fluid text-center">
  <div class="col-sm-12 sidenav">
      ...
      <button class="button" onclick="window.location.href='trix.html'">MY PROFILE</button>
      <button class="button" onclick="window.location.href='selflesson.html'">NEWS</button>
      <button class="button" onclick="window.location.href='gametrailers.html'">BLOOD DONATION</button>
      <button class="button" onclick="window.location.href='movietrailers.html'">KIDNEYS</button>
      <button class="button" onclick="window.location.href='website.php'">LOGOUT</button>
  ...
  <div class="row content" >
    <div class="col-sm-3 sidenav">
      <div class="container-fluid text-center">
        <div class="col-sm-12 sidenav">
          ...
          <label align="left" > 
            <?php 
              echo "HELLO ".$rs['username']; 
              echo "<br>";
              echo "Your NIC is ".$rs['nic'];
              echo "<br>";
              echo "Your blood group is ".$rs['bloodgroup']; 
              echo "<br>";
              echo $rs['image']; 
            ?> 
          </label></br>
    ...
    <div class="col-sm-6 sidenav" >
      ...
      <div class="slideshow-container" >
          ...
          <img src="images/2.jpg" style="width:580px" >
          </div>

          <div class="mySlides fade" align="center">
          <img src="images/3.jpg" style="width:580px">
          </div>

          <div class="mySlides fade" align="center">
          <img src="images/4.jpg" style="width:580px">
          </div>

          <div class="mySlides fade" align="center">
          <img src="images/5.jpg" style="width:580px">
          </div>
